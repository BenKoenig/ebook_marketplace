<template>
    ...
    <div class="relative css-selector border-b-2 border-black">
        ...
        <div class=" relative md:grid  md:grid-cols-12 justify-center  max-w-8xl mx-auto gap-x-14 px-2 xl:px-0">
            ...
            <div class="md:col-span-6 pb-2 md:pb-0 relative">
                ...
                <h1 class=" text-2xl md:text-3xl z-10  courier_prime  relative font_courier mb-2"> <i class="fa fa-times"></i> eBook Marketplace for Developers</h1>
