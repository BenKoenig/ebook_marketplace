<template>
    <div>
        ...
        <div class="layout">
            ...
            <nav class="sticky top-0 h-screen hidden md:block border-r border-black px-5" >
                <ul class="layout__desktopNav__ul">
                    <li class="layout__desktopNav__ul__li layout__desktopNav__ul__li--mb mt-5">
        ...
        <footer class="component--paddingY  flex flex-col border-t border-black">
