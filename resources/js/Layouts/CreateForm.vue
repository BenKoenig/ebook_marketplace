...
<template>
    ...
    <form @submit.prevent="submit" class="max-w-4xl mx-auto py-10">
        ...
        <div class="md:grid grid-cols-2 gap-x-3">
            ...
            <div class="mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="banner">Upload Banner Image</label>
                <input class="block w-full text-sm text-gray-900 bg-gray-50  border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="banner_help"  id="banner" type="file">
