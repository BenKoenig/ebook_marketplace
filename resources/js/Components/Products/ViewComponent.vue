    ...
    <div class="">
        <div class="container mx-auto sm:grid sm:grid-cols-12 gap-x-14 p-2 lg:p-10  rounded-lg  bg-beige-4">
            <div class="sm:sticky sm:top-1 h-fit  w-full sm:col-span-4 xl:col-span-3 sm:order-2  mx-auto relative">
                ...
                <!-- Review container -->
                <div class="bg-white border-2 border-black mb-1 flex flex-col items-center  py-6 rounded-lg">
                ...
                <div class="flex gap-1">
                    ...
                    <!-- Link to reviews -->
                    <Link :href="route('dashboard')" class="bg-white border-2 border-black text-lg flex w-full h-10 justify-center items-center rounded-lg">
                        Reviews
                    </Link>

                    <!-- Link to buy -->
                    <Link :href="route('dashboard')" class="bg-yellow-200 border-2 border-black text-lg flex w-full h-10 justify-center items-center rounded-lg">
                        Buy
                    </Link>
